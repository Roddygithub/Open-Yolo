...
def create_crosshair_cursor():
    ...
    # Lignes du viseur
    draw.line([(center - radius, center), (center + radius, center)], fill='white', width=2)
    draw.line([(center, center - radius), (center, center + radius)], fill='white', width=2)
    
    # Contour noir pour la visibilité
    draw.line([(center - radius - 1, center), (center + radius + 1, center)], fill='black', width=1)
    draw.line([(center, center - radius - 1), (center, center + radius + 1)], fill='black', width=1)
