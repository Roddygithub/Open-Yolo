...
public:
    ...
    struct Shortcut {
        ...
        Shortcut() = default;
        Shortcut(const std::string& accel, guint key, Gdk::ModifierType modifiers,
     ...
     */
    void setupGTKIntegration(Gtk::Window* window,
    ...
    /**
     * Vérifie si le gestionnaire d'entrée est initialisé
...
private:
    ...
    void onDeviceRemoved(
        const Glib::RefPtr<Gdk::Device>& device);  // Gestion de la suppression d'un périphérique
    ...
    bool initialized_ = false;  // État d'initialisation
