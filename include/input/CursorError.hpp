...
inline CursorError CursorError::fromErrno(int errnum, const std::string& path) {
    ...
    switch (errnum) {
        case ENOENT:  code = CursorErrorCode::CEC_FileNotFound; break;
        case EACCES:  
        case EPERM:   code = CursorErrorCode::CEC_FilePermissionDenied; break;
        case EEXIST:  code = CursorErrorCode::CEC_FileAlreadyExists; break;
        case ENOSPC:
        case EDQUOT:  code = CursorErrorCode::CEC_SystemError; break;
        default:      code = CursorErrorCode::CEC_SystemError; break;
    }
...
inline std::string cursorErrorCodeToString(CursorErrorCode code) {
    ...
    switch (code) {
        case CEC::CEC_Success: return "Success";
        case CEC::CEC_UnknownError: return "Unknown error";
        case CEC::CEC_FileNotFound: return "File not found";
        case CEC::CEC_FileReadError: return "File read error";
        case CEC::CEC_FileWriteError: return "File write error";
        case CEC::CEC_FilePermissionDenied: return "Permission denied";
        case CEC::CEC_FileAlreadyExists: return "File already exists";
        case CEC::CEC_ProfileNotFound: return "Profile not found";
        case CEC::CEC_ProfileAlreadyExists: return "Profile already exists";
        case CEC::CEC_InvalidProfile: return "Invalid profile";
        case CEC::CEC_ThemeNotFound: return "Theme not found";
        case CEC::CEC_InvalidTheme: return "Invalid theme";
        case CEC::CEC_ThemeInstallationFailed: return "Theme installation failed";
        case CEC::CEC_CursorNotFound: return "Cursor not found";
        case CEC::CEC_InvalidCursorFormat: return "Invalid cursor format";
        case CEC::CEC_CursorGenerationFailed: return "Cursor generation failed";
        case CEC::CEC_SystemError: return "System error";
        case CEC::CEC_InsufficientPermissions: return "Insufficient permissions";
        case CEC::CEC_DependencyMissing: return "Missing dependency";
    ...
    return "Unknown error code: " + std::to_string(static_cast<int>(code)); // Should not be reached
}
