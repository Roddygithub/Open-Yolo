...
void ShortcutManager::registerShortcut(const std::vector<unsigned int>& keys, Callback callback,
...
ShortcutConfig& ShortcutManager::getConfig() { return m_config; }

const ShortcutConfig& ShortcutManager::getConfig() const { return m_config; }
